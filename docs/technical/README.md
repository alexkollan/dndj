...
13. **[Integrity & Reliability](./13-integrity.md)** — DB↔filesystem checks, the launch cleanup gate, the health-check button, relinking, and real renames.
14. **[Import Pipeline](./14-import.md)** — importing files/folders/zips with stage→map→commit and category mapping.
...
└── src/
    ...
    ├── importer.js         # Import staging/commit (files, folders, zips)
